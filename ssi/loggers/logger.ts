/**
 * Logger Configuration - Winston-based logging system for IPAM-NAM-NSG-SSI
...
logger.on("error", (error: Error) => {
  logger.warning(`ipam-nam-nsg-ssi: Error in logger ${error.message}`, {
    component: "logger",
...
const addHecLogger = () => {
  try {
    ...
    logger.error(
      `ipam-nam-nsg-ssi: Error on WinstonHecLogger,  ${
...
export const removeHecLogger = () => {
  try {
    ...
    logger.error(
      `ipam-nam-nsg-ssi: Error on removeHecLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
export const addFileLoggers = () => {
  try {
    ...
    logger.error(
      `ipam-nam-nsg-ssi: Error on FileLogger,  ${(error as Error).message}`,
      {
        component: "logger",
...
export const removeFileLoggers = () => {
  try {
    ...
    logger.error(
      `ipam-nam-nsg-ssi: Error on removeFileLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
export const addSplunkFileLogger = () => {
  try {
    ...
    logger.error(
      `ipam-nam-nsg-ssi: Error on SplunkFileLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
export const removeSplunkFileLogger = () => {
  try {
    ...
    logger.error(
      `ipam-nam-nsg-ssi: Error on removeSplunkFileLogger,  ${
        (error as Error).message
      }`,
      {
        component: "logger",
...
logger.debug(`ipam-nam-nsg-ssi: Logger initialized at ${logLevel()} level`);
